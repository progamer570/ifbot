...
export default async function addToPremiumHandler(ctx) {
    ...
    if (!args || args.length < 1) {
        await ctx.reply("Please specify the day duration (e.g., /addtopremium 1d or /addtopremium userid 1d [for days]).");
        return;
    }
    if (args.length === 3) {
