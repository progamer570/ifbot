 ...
 */
export async function addToWebsite(imageUrl, aIOData = {}) {
    try {
...
export async function updateToWebsite(shareId, isPoster, updateQuery) {
    try {
        const payload = JSON.stringify({
            isPoster,
            shareId,
...
export async function deleteToWebsite(shareId) {
    try {
        const response = await fetch(`${env.apiBaseUrl}/aio`, {
            method: "DELETE",
            headers: {
