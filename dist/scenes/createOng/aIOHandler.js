...
function done(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var text, _a, backupChannel, messageIds_1, aIOPosterID, captions, _b, aIOTitle, webPhotoUrl, photoUrl, AIODetails, forwardedMessageIds, AIOData, shareId, link, botUsername, _c, links, error_1, user, _d, error_2, caption;
        ...
        return __generator(this, function (_m) {
            switch (_m.label) {
                ...
                case 3:
                    ...
                    _a = ctx.session, backupChannel = _a.backupChannel, messageIds_1 = _a.messageIds, aIOPosterID = _a.aIOPosterID, captions = _a.captions;
                ...
                case 6:
                    ...
                    _m.label = 7;
                case 7:
                    _m.trys.push([7, 24, , 26]);
                    return [4 /*yield*/, getAIOdata(AIODetails, forwardedMessageIds, "ongoing")];
                case 8:
                    AIOData = _m.sent();
                    shareId = void 0;
                    link = void 0;
                ...
                case 12:
                    _m.sent();
                    return [4 /*yield*/, ctx.scene.leave()];
                case 13: return [2 /*return*/, _m.sent()];
                ...
                case 16:
                    ...
                    if (!captions || !messageIds_1) {
                        console.error("Error: captions or messageIds is undefined");
                        return [2 /*return*/];
                    }
                    links = captions.map(function (caption, index) { return ({
                        caption: caption,
                        messageId: messageIds_1[index] || "",
                    }); });
                    return [4 /*yield*/, sendToCollectionOng2(env.collectionAIO, aIOPosterID, links)];
                case 17:
                    _m.sent();
                    return [3 /*break*/, 19];
                case 18:
                ...
                case 23: return [2 /*return*/, _m.sent()];
                case 24:
                    error_2 = _m.sent();
                    return [4 /*yield*/, ctx.scene.leave()];
                case 25: return [2 /*return*/, _m.sent()];
